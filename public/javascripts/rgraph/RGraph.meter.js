    ...
    */
    RGraph.Meter.prototype.Draw = function ()
    {
        ...
        */
        ...
        this.centery = RGraph.GetHeight(this) - this.gutterBottom;
        this.radius  = Math.min(RGraph.GetWidth(this) - this.gutterLeft - this.gutterRight, RGraph.GetHeight(this) - this.gutterTop - this.gutterBottom);
